...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_DEC_HEAD_Q,                             "dec.head_q" },
    { LLM_TENSOR_DEC_HEAD_K,                             "dec.head_k" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_DEC_HEAD_Q,                 {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
    {LLM_TENSOR_DEC_HEAD_K,                 {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
